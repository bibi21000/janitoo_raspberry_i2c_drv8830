...
setup(
    name = 'janitoo_raspberry_i2c_drv8830',
    description = "Manage a drv8830 with Janitoo",
    long_description = """Provides components for DC motor    """,
    ...
    package_dir = { '': 'src' },
    keywords = "raspberry,i2c,motor,led,adafruit,servo,drv8830,pwm",
